...
public class Account extends AbstractDescribedSObjectBase {
    ...
    // zregvart__CustomerPriority__c
    @XStreamConverter(PicklistEnumConverter.class)
    private Account_zregvart__CustomerPriorityEnum zregvart__CustomerPriority__c;

    @JsonProperty("zregvart__CustomerPriority__c")
    public Account_zregvart__CustomerPriorityEnum getzregvart__CustomerPriority__c() {
        return this.zregvart__CustomerPriority__c;
    }

    @JsonProperty("zregvart__CustomerPriority__c")
    public void setzregvart__CustomerPriority__c(Account_zregvart__CustomerPriorityEnum zregvart__CustomerPriority__c) {
        this.zregvart__CustomerPriority__c = zregvart__CustomerPriority__c;
    }

    // zregvart__SLA__c
    @XStreamConverter(PicklistEnumConverter.class)
    private Account_zregvart__SLAEnum zregvart__SLA__c;

    @JsonProperty("zregvart__SLA__c")
    public Account_zregvart__SLAEnum getzregvart__SLA__c() {
        return this.zregvart__SLA__c;
    }

    @JsonProperty("zregvart__SLA__c")
    public void setzregvart__SLA__c(Account_zregvart__SLAEnum zregvart__SLA__c) {
        this.zregvart__SLA__c = zregvart__SLA__c;
    }

    // zregvart__Active__c
    @XStreamConverter(PicklistEnumConverter.class)
    private Account_zregvart__ActiveEnum zregvart__Active__c;

    @JsonProperty("zregvart__Active__c")
    public Account_zregvart__ActiveEnum getzregvart__Active__c() {
        return this.zregvart__Active__c;
    }

    @JsonProperty("zregvart__Active__c")
    public void setzregvart__Active__c(Account_zregvart__ActiveEnum zregvart__Active__c) {
        this.zregvart__Active__c = zregvart__Active__c;
    }
    ...
    // zregvart__UpsellOpportunity__c
    @XStreamConverter(PicklistEnumConverter.class)
    private Account_zregvart__UpsellOpportunityEnum zregvart__UpsellOpportunity__c;

    @JsonProperty("zregvart__UpsellOpportunity__c")
    public Account_zregvart__UpsellOpportunityEnum getzregvart__UpsellOpportunity__c() {
        return this.zregvart__UpsellOpportunity__c;
    }

    @JsonProperty("zregvart__UpsellOpportunity__c")
    public void setzregvart__UpsellOpportunity__c(Account_zregvart__UpsellOpportunityEnum zregvart__UpsellOpportunity__c) {
        this.zregvart__UpsellOpportunity__c = zregvart__UpsellOpportunity__c;
    }

    // zregvart__SLASerialNumber__c
    private String zregvart__SLASerialNumber__c;

    @JsonProperty("zregvart__SLASerialNumber__c")
    public String getzregvart__SLASerialNumber__c() {
        return this.zregvart__SLASerialNumber__c;
    }

    @JsonProperty("zregvart__SLASerialNumber__c")
    public void setzregvart__SLASerialNumber__c(String zregvart__SLASerialNumber__c) {
        this.zregvart__SLASerialNumber__c = zregvart__SLASerialNumber__c;
    }

    // zregvart__SLAExpirationDate__c
    private java.time.ZonedDateTime zregvart__SLAExpirationDate__c;

    @JsonProperty("zregvart__SLAExpirationDate__c")
    public java.time.ZonedDateTime getzregvart__SLAExpirationDate__c() {
        return this.zregvart__SLAExpirationDate__c;
    }

    @JsonProperty("zregvart__SLAExpirationDate__c")
    public void setzregvart__SLAExpirationDate__c(java.time.ZonedDateTime zregvart__SLAExpirationDate__c) {
        this.zregvart__SLAExpirationDate__c = zregvart__SLAExpirationDate__c;
    }

    // zregvart__Shipping_Location__Latitude__s
    private Double zregvart__Shipping_Location__Latitude__s;

    @JsonProperty("zregvart__Shipping_Location__Latitude__s")
    public Double getzregvart__Shipping_Location__Latitude__s() {
        return this.zregvart__Shipping_Location__Latitude__s;
    }

    @JsonProperty("zregvart__Shipping_Location__Latitude__s")
    public void setzregvart__Shipping_Location__Latitude__s(Double zregvart__Shipping_Location__Latitude__s) {
        this.zregvart__Shipping_Location__Latitude__s = zregvart__Shipping_Location__Latitude__s;
    }

    // zregvart__Shipping_Location__Longitude__s
    private Double zregvart__Shipping_Location__Longitude__s;

    @JsonProperty("zregvart__Shipping_Location__Longitude__s")
    public Double getzregvart__Shipping_Location__Longitude__s() {
        return this.zregvart__Shipping_Location__Longitude__s;
    }

    @JsonProperty("zregvart__Shipping_Location__Longitude__s")
    public void setzregvart__Shipping_Location__Longitude__s(Double zregvart__Shipping_Location__Longitude__s) {
        this.zregvart__Shipping_Location__Longitude__s = zregvart__Shipping_Location__Longitude__s;
    }

    // zregvart__Shipping_Location__c
    private org.apache.camel.component.salesforce.api.dto.GeoLocation zregvart__Shipping_Location__c;

    @JsonProperty("zregvart__Shipping_Location__c")
    public org.apache.camel.component.salesforce.api.dto.GeoLocation getzregvart__Shipping_Location__c() {
        return this.zregvart__Shipping_Location__c;
    }

    @JsonProperty("zregvart__Shipping_Location__c")
    public void setzregvart__Shipping_Location__c(org.apache.camel.component.salesforce.api.dto.GeoLocation zregvart__Shipping_Location__c) {
        this.zregvart__Shipping_Location__c = zregvart__Shipping_Location__c;
    }
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        infoUrls1.setLayout("/services/data/v37.0/sobjects/Account/describe/layouts/012000000000000AAA");
        ...
        sObjectDescriptionUrls1.setDescribe("/services/data/v37.0/sobjects/Account/describe");
        sObjectDescriptionUrls1.setLayouts("/services/data/v37.0/sobjects/Account/describe/layouts");
        sObjectDescriptionUrls1.setSobject("/services/data/v37.0/sobjects/Account");
        sObjectDescriptionUrls1.setQuickActions("/services/data/v37.0/sobjects/Account/quickActions");
        sObjectDescriptionUrls1.setUiEditTemplate("https://eu11.salesforce.com/{ID}/e");
        sObjectDescriptionUrls1.setDefaultValues("/services/data/v37.0/sobjects/Account/defaultValues?recordTypeId&fields");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v37.0/sobjects/Account/{ID}");
        sObjectDescriptionUrls1.setListviews("/services/data/v37.0/sobjects/Account/listviews");
        sObjectDescriptionUrls1.setCompactLayouts("/services/data/v37.0/sobjects/Account/describe/compactLayouts");
        sObjectDescriptionUrls1.setApprovalLayouts("/services/data/v37.0/sobjects/Account/describe/approvalLayouts");
        ...
        sObjectField14.setLabel("Billing Geocode Accuracy");
        sObjectField14.setHighScaleNumber(false);
        sObjectField14.setDisplayLocationInDecimal(false);
        sObjectField14.setName("BillingGeocodeAccuracy");
        ...
        sObjectField15.setSoapType("urn:address");
        ...
        sObjectField15.setType("address");
        sObjectField15.setSortable(false);
        sObjectField15.setLength(0);
        sObjectField15.setPrecision(0);
        sObjectField15.setByteLength(0);
        sObjectField15.setQueryByDistance(true);
        sObjectField15.setFilterable(true);
        sObjectField15.setUpdateable(false);
        ...
        sObjectField16.setType("textarea");
        ...
        sObjectField18.setLength(80);
        sObjectField18.setPrecision(0);
        sObjectField18.setByteLength(240);
        ...
        sObjectField19.setLabel("Shipping Zip/Postal Code");
        sObjectField19.setHighScaleNumber(false);
        sObjectField19.setDisplayLocationInDecimal(false);
        sObjectField19.setName("ShippingPostalCode");
        ...
        sObjectField19.setLength(20);
        sObjectField19.setPrecision(0);
        sObjectField19.setByteLength(60);
        ...
        sObjectField23.setLabel("Shipping Geocode Accuracy");
        sObjectField23.setHighScaleNumber(false);
        sObjectField23.setDisplayLocationInDecimal(false);
        sObjectField23.setName("ShippingGeocodeAccuracy");
        ...
        sObjectField25.setLabel("Account Phone");
        ...
        sObjectField26.setLabel("Account Fax");
        ...
        sObjectField29.setType("url");
        sObjectField29.setSortable(true);
        sObjectField29.setLength(255);
        sObjectField29.setPrecision(0);
        sObjectField29.setByteLength(765);
        ...
        sObjectField30.setLength(20);
        sObjectField30.setPrecision(0);
        sObjectField30.setByteLength(60);
        ...
        sObjectField33.setSoapType("xsd:int");
        ...
        sObjectField34.setType("picklist");
        sObjectField34.setSortable(true);
        sObjectField34.setLength(40);
        sObjectField34.setPrecision(0);
        sObjectField34.setByteLength(120);
        ...
        sObjectField35.setLength(20);
        sObjectField35.setPrecision(0);
        sObjectField35.setByteLength(60);
        ...
        sObjectField36.setType("textarea");
        sObjectField36.setSortable(false);
        sObjectField36.setLength(32000);
        sObjectField36.setPrecision(0);
        sObjectField36.setByteLength(96000);
        sObjectField36.setQueryByDistance(false);
        sObjectField36.setFilterable(false);
        ...
        sObjectField38.setLength(80);
        sObjectField38.setPrecision(0);
        sObjectField38.setByteLength(240);
        ...
        sObjectField39.setReferenceTo(referenceTo3);
        ...
        sObjectField49.setRelationshipName("JigsawCompany");
        sObjectField49.setSortable(true);
        sObjectField49.setLength(20);
        sObjectField49.setPrecision(0);
        sObjectField49.setByteLength(60);
        ...
        sObjectField50.setType("picklist");
        sObjectField50.setSortable(true);
        sObjectField50.setLength(40);
        sObjectField50.setPrecision(0);
        sObjectField50.setByteLength(120);
        ...
        sObjectField51.setType("picklist");
        sObjectField51.setSortable(true);
        sObjectField51.setLength(40);
        sObjectField51.setPrecision(0);
        sObjectField51.setByteLength(120);
        ...
        sObjectField52.setLength(9);
        sObjectField52.setPrecision(0);
        sObjectField52.setByteLength(27);
        ...
        sObjectField54.setLength(8);
        sObjectField54.setPrecision(0);
        sObjectField54.setByteLength(24);
        ...
        sObjectField55.setLength(120);
        sObjectField55.setPrecision(0);
        sObjectField55.setByteLength(360);
        ...
        sObjectField56.setLength(4);
        sObjectField56.setPrecision(0);
        sObjectField56.setByteLength(12);
        ...
        sObjectField57.setLength(80);
        sObjectField57.setPrecision(0);
        sObjectField57.setByteLength(240);
        ...
        sObjectField58.setSoapType("tns:ID");
        ...
        sObjectField58.setType("reference");

        final List<String> referenceTo6 = new ArrayList<>();
        sObjectField58.setReferenceTo(referenceTo6);

        referenceTo6.add("DandBCompany");

        sObjectField58.setRelationshipName("DandbCompany");
        sObjectField58.setSortable(true);
        sObjectField58.setLength(18);
        sObjectField58.setPrecision(0);
        sObjectField58.setByteLength(18);
        ...
        sObjectField59.setLabel("Customer Priority");
        sObjectField59.setHighScaleNumber(false);
        sObjectField59.setDisplayLocationInDecimal(false);
        sObjectField59.setName("zregvart__CustomerPriority__c");
        ...
        sObjectField60.setType("picklist");
        sObjectField60.setSortable(true);
        sObjectField60.setLength(255);
        sObjectField60.setPrecision(0);
        sObjectField60.setByteLength(765);
        ...
        sObjectField62.setLabel("Number of Locations");
        sObjectField62.setHighScaleNumber(false);
        sObjectField62.setDisplayLocationInDecimal(false);
        sObjectField62.setName("zregvart__NumberofLocations__c");
        ...
        sObjectField62.setSoapType("xsd:double");
        sObjectField62.setGroupable(false);
        ...
        sObjectField62.setType("double");
        sObjectField62.setSortable(true);
        sObjectField62.setLength(0);
        sObjectField62.setPrecision(3);
        sObjectField62.setByteLength(0);
        ...
        sObjectField63.setLabel("Upsell Opportunity");
        sObjectField63.setHighScaleNumber(false);
        sObjectField63.setDisplayLocationInDecimal(false);
        sObjectField63.setName("zregvart__UpsellOpportunity__c");
        ...
        sObjectField63.setSoapType("xsd:string");
        ...
        sObjectField63.setType("picklist");
        sObjectField63.setSortable(true);
        sObjectField63.setLength(255);
        sObjectField63.setPrecision(0);
        sObjectField63.setByteLength(765);
        ...
        sObjectField64.setLabel("SLA Serial Number");
        sObjectField64.setHighScaleNumber(false);
        sObjectField64.setDisplayLocationInDecimal(false);
        sObjectField64.setName("zregvart__SLASerialNumber__c");
        ...
        sObjectField64.setSoapType("xsd:string");
        sObjectField64.setGroupable(true);
        sObjectField64.setCustom(true);
        sObjectField64.setScale(0);
        ...
        sObjectField64.setType("string");
        sObjectField64.setSortable(true);
        sObjectField64.setLength(10);
        sObjectField64.setPrecision(0);
        sObjectField64.setByteLength(30);
        ...
        sObjectField65.setLabel("SLA Expiration Date");
        sObjectField65.setHighScaleNumber(false);
        sObjectField65.setDisplayLocationInDecimal(false);
        sObjectField65.setName("zregvart__SLAExpirationDate__c");
        ...
        sObjectField65.setSoapType("xsd:date");
        sObjectField65.setGroupable(true);
        sObjectField65.setCustom(true);
        sObjectField65.setScale(0);
        ...
        sObjectField66.setSoapType("xsd:double");
        sObjectField66.setGroupable(false);
        sObjectField66.setCustom(true);
        sObjectField66.setScale(3);
        ...
        sObjectField66.setType("double");
        sObjectField66.setSortable(true);
        sObjectField66.setLength(0);
        sObjectField66.setPrecision(6);
        sObjectField66.setByteLength(0);
        sObjectField66.setQueryByDistance(false);
        sObjectField66.setFilterable(true);
        sObjectField66.setUpdateable(true);
        sObjectField66.setUnique(false);
        sObjectField66.setAutoNumber(false);

        final SObjectField sObjectField67 = new SObjectField();
        fields1.add(sObjectField67);

        sObjectField67.setWriteRequiresMasterRead(false);
        sObjectField67.setNillable(true);
        sObjectField67.setCreateable(true);
        sObjectField67.setEncrypted(false);
        sObjectField67.setDigits("0");
        sObjectField67.setDependentPicklist(false);
        sObjectField67.setLabel("Shipping_Location (Longitude)");
        sObjectField67.setHighScaleNumber(false);
        sObjectField67.setDisplayLocationInDecimal(false);
        sObjectField67.setName("zregvart__Shipping_Location__Longitude__s");
        sObjectField67.setHtmlFormatted(false);
        sObjectField67.setDeprecatedAndHidden(false);
        sObjectField67.setRestrictedPicklist(false);
        sObjectField67.setNameField(false);
        sObjectField67.setCaseSensitive(false);
        sObjectField67.setPermissionable(true);
        sObjectField67.setCascadeDelete(false);
        sObjectField67.setDefaultedOnCreate(false);
        sObjectField67.setExternalId(false);
        sObjectField67.setSoapType("xsd:double");
        sObjectField67.setGroupable(false);
        sObjectField67.setCustom(true);
        sObjectField67.setScale(3);
        sObjectField67.setCalculated(false);
        sObjectField67.setRestrictedDelete(false);
        sObjectField67.setNamePointing(false);
        sObjectField67.setIdLookup(false);
        sObjectField67.setType("double");
        sObjectField67.setSortable(true);
        sObjectField67.setLength(0);
        sObjectField67.setPrecision(6);
        sObjectField67.setByteLength(0);
        sObjectField67.setQueryByDistance(false);
        sObjectField67.setFilterable(true);
        sObjectField67.setUpdateable(true);
        sObjectField67.setUnique(false);
        sObjectField67.setAutoNumber(false);

        final SObjectField sObjectField68 = new SObjectField();
        fields1.add(sObjectField68);

        sObjectField68.setWriteRequiresMasterRead(false);
        sObjectField68.setNillable(true);
        sObjectField68.setCreateable(false);
        sObjectField68.setEncrypted(false);
        sObjectField68.setDigits("0");
        sObjectField68.setDependentPicklist(false);
        sObjectField68.setLabel("Shipping_Location");
        sObjectField68.setHighScaleNumber(false);
        sObjectField68.setDisplayLocationInDecimal(false);
        sObjectField68.setName("zregvart__Shipping_Location__c");
        sObjectField68.setHtmlFormatted(false);
        sObjectField68.setDeprecatedAndHidden(false);
        sObjectField68.setRestrictedPicklist(false);
        sObjectField68.setNameField(false);
        sObjectField68.setCaseSensitive(false);
        sObjectField68.setPermissionable(true);
        sObjectField68.setCascadeDelete(false);
        sObjectField68.setDefaultedOnCreate(false);
        sObjectField68.setExternalId(false);
        sObjectField68.setSoapType("urn:location");
        sObjectField68.setGroupable(false);
        sObjectField68.setCustom(true);
        sObjectField68.setScale(0);
        sObjectField68.setCalculated(false);
        sObjectField68.setRestrictedDelete(false);
        sObjectField68.setNamePointing(false);
        sObjectField68.setIdLookup(false);
        sObjectField68.setType("location");
        sObjectField68.setSortable(false);
        sObjectField68.setLength(0);
        sObjectField68.setPrecision(0);
        sObjectField68.setByteLength(0);
        sObjectField68.setQueryByDistance(false);
        sObjectField68.setFilterable(false);
        sObjectField68.setUpdateable(false);
        sObjectField68.setUnique(false);
        sObjectField68.setAutoNumber(false);
